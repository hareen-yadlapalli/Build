  ...
  stages {
    stage('Execute Scripts') {
      ...
      parameters {
        ...
        string(name: 'DBServerName', defaultValue: 'desktop-icvg5t9', description: 'Database Server Name Eg mydesktop')
        ...
        string(name: 'ImplScriptsLoc', defaultValue: 'C:\Users\Sowmya\Desktop\Hareen', description: 'Implementation Scritps Location')
        string(name: 'ImplScripts', defaultValue: 'sqlfile1.sql', description: 'Implementation Scripts Eg sqlfile1.sql')
        string(name: 'RBScriptsLoc', defaultValue: 'C:\Users\Sowmya\Desktop\Hareen', description: 'Rollback Scripts Location')
